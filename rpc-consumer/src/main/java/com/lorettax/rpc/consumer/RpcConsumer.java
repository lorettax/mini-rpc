...
import com.lorettax.rpc.handler.RpcResponseHandler;
...
public class RpcConsumer {
    ...
    public void sendRequest(LinkRpcProtocol<LinkRpcRequest> protocol, RegistryService registryService) throws Exception {
        LinkRpcRequest request = protocol.getBody();
